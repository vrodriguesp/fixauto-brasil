...
CREATE TYPE tipo_servico AS ENUM ('colisao', 'manutencao', 'funilaria', 'pintura', 'mecanica', 'eletrica', 'outro');
...
-- Solicitacao Fotos (Request Photos)
...
-- Orcamento Itens (Quote Line Items)
...
-- Oficinas: anyone can read active, owner can update
...
-- Solicitacoes: clients see own, workshops see open ones
...
-- Fotos: viewable by all, insertable by request owner
...
-- Orcamentos: viewable by request owner and quote creator
